...
use TarBlog\Routing\Exceptions\UrlGenerationException;
...
class RouteUrlGenerator
{
     ...
     *
     * @var \TarBlog\Routing\UrlGenerator
     */
    protected $url;
     ...
     *
     * @param  \TarBlog\Routing\UrlGenerator  $url
    ...
    public function to($route, $parameters = [], $absolute = false)
    {
        ...
        $uri = $this->addQueryString($this->url->format(
            $root = $this->replaceRootParameters($route, $parameters),
    ...
    protected function formatDomain($route, &$parameters)
    {
        return $this->addPortToDomain(
            $this->url->formatScheme().$route->getDomain()
        );
    }
     ...
     * @return string
     */
    protected function replaceRootParameters($route, &$parameters)
    {
        $scheme = $this->url->formatScheme();

        return $this->replaceRouteParameters(
            $this->url->formatRoot($scheme), $parameters
        );
    }
