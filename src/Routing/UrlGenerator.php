...
use TarBlog\Routing\Exceptions\RouteNotFoundException;
...
class UrlGenerator implements UrlGeneratorContract
{
     ...
     *
     * @var \TarBlog\Routing\RouteUrlGenerator|null
     */
     ...
     *
     * @param  \TarBlog\Routing\RouteCollection  $routes
    ...
    public function asset($path, $secure = null)
    {
        ...
        $root = $this->assetRoot
                    ? $this->assetRoot
                    : $this->formatRoot($this->formatScheme($secure)).'/usr/theme/'.config('theme','default');
     ...
     * @return string
     *
     * @throws \TarBlog\Routing\Exceptions\RouteNotFoundException
     */
     ...
     * @return string
     *
     * @throws \TarBlog\Routing\Exceptions\UrlGenerationException
     */
     ...
     * @param  string  $root
     * @param  string  $path
     * @param  \TarBlog\Routing\Route|null  $route
     * @return string
     */
     ...
     *
     * @return \TarBlog\Routing\RouteUrlGenerator
     */
