...
if (! function_exists('csrf_field')) {
    ...
    {
        $html = new HtmlString('<input type="hidden" name="_token" value="'.csrf_token().'">');
        if ($echo) echo $html;
        return $html;
    }
}
...
if (! function_exists('redirect')) {
     ...
     * @param  array  $headers
     * @param  bool|null  $secure
     * @return \TarBlog\Routing\Redirector|\Illuminate\Http\RedirectResponse
     */
...
if (! function_exists('response')) {
     ...
     *
     * @param  \TarBlog\View\View|string|array|null  $content
     * @param  int  $status
     * @param  array  $headers
...
if (! function_exists('view')) {
     ...
     * @return \TarBlog\View\View|\Illuminate\Contracts\View\Factory
     */
